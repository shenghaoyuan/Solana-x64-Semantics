...
lemma encode_xchgq_rr_1_subgoal_1: "and 15 ((v::u8) >> 4) = 4 \<Longrightarrow> bit (v::u8) 3 \<Longrightarrow> \<not> bit v (Suc 0) \<Longrightarrow>
...
lemma encode_xchgq_rr_1_subgoal_2 [simp]: "and 15 ((v::u8) >> 4) = 4 \<Longrightarrow> bit v 3 \<Longrightarrow>
  \<not> bit v (Suc 0) \<Longrightarrow> bit v 0 \<Longrightarrow> bit (v >> 2) 0 \<Longrightarrow> v = 77"
  apply (rule bit_eqI)
  subgoal for n
    apply (auto simp add: bit_simps)
    subgoal using encode_xchgq_rr_1_subgoal_1 by blast
    done
  done
...
lemma encode_xchgq_rr_1_subgoal_3: "and 15 ((v::u8) >> 4) = 4 \<Longrightarrow> bit (v::u8) 3 \<Longrightarrow> \<not> bit v (Suc 0) \<Longrightarrow>
...
lemma encode_xchgq_rr_1_subgoal_4 [simp]: "and 15 ((v::u8) >> 4) = 4 \<Longrightarrow> bit v 3 \<Longrightarrow>
  \<not> bit v (Suc 0) \<Longrightarrow> bit v 0 \<Longrightarrow> \<not> bit (v >> 2) 0 \<Longrightarrow> v = 73"
  apply (rule bit_eqI)
  subgoal for n
    apply (auto simp add: bit_simps)
    subgoal using encode_xchgq_rr_1_subgoal_3 by blast
    done
  done
...
lemma encode_xchgq_rr_1_subgoal_5: "and 15 ((v::u8) >> 4) = 4 \<Longrightarrow> bit (v::u8) 3 \<Longrightarrow> \<not> bit v (Suc 0) \<Longrightarrow>
...
lemma encode_xchgq_rr_1_subgoal_6 [simp]: "and 15 ((v::u8) >> 4) = 4 \<Longrightarrow> bit v 3 \<Longrightarrow>
  \<not> bit v (Suc 0) \<Longrightarrow> \<not> bit v 0 \<Longrightarrow> bit (v >> 2) 0 \<Longrightarrow> v = 76"
  apply (rule bit_eqI)
  subgoal for n
    apply (auto simp add: bit_simps)
    subgoal using encode_xchgq_rr_1_subgoal_5 by blast
    done
  done
...
lemma encode_xchgq_rr_1_subgoal_7: "and 15 ((v::u8) >> 4) = 4 \<Longrightarrow> bit (v::u8) 3 \<Longrightarrow> \<not> bit v (Suc 0) \<Longrightarrow>
...
lemma encode_xchgq_rr_1_subgoal_8 [simp]: "and 15 ((v::u8) >> 4) = 4 \<Longrightarrow> bit v 3 \<Longrightarrow>
  \<not> bit v (Suc 0) \<Longrightarrow> \<not> bit v 0 \<Longrightarrow> \<not> bit (v >> 2) 0 \<Longrightarrow> v = 72"
  apply (rule bit_eqI)
  subgoal for n
    apply (auto simp add: bit_simps)
    subgoal using encode_xchgq_rr_1_subgoal_7 by blast
    done
  done

lemma encode_xchgq_rr_1_subgoal_9 [simp]: "and 3 ((k::u8) >> 6) = 3 \<Longrightarrow>
