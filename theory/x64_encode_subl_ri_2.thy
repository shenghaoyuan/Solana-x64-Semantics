...
lemma encode_subl_ri_2: "
    and 3 (v >> 6) = 3 \<Longrightarrow>    and 7 (v >> 3) = 5 \<Longrightarrow>
    ...
    bitfield_insert_u8 4 4
     (bitfield_insert_u8 3 (Suc 0) (bitfield_insert_u8 2 (Suc 0) (bitfield_insert_u8 (Suc 0) (Suc 0) 
      (u8_of_bool (and (u8_of_ireg dst) 8 \<noteq> 0)) 0) 0) 0) 4 = 129 \<and>
    l ! Suc (Suc pc) = bitfield_insert_u8 6 2 (bitfield_insert_u8 3 3 (and 7 (u8_of_ireg dst)) 5) 3 \<and>
