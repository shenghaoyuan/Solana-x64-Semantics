  ...
  subgoal for h
    ...
    subgoal for op
      ...
      subgoal
        ...
        apply (subst add.assoc [of pc n 6])
                  apply (frule list_in_list_nth_error [of _ _ _ "n+6" _], assumption, simp)
                  subgoal for i4 apply (cases "ireg_of_u8 (bitfield_insert_u8 3 (Suc n) (and 7 reg) (and 1 h))"; simp)
                  subgoal for dst apply (cases "u32_of_u8_list [i1, i2, i3, i4]"; simp)
                  subgoal for imm apply (cases "and 7 (reg >> 3) = 0 \<and> and 1 (h >> 2) = 0 \<and> and 1 (h >> Suc n) = 0"; simp)
                  apply (cases "and 3 (reg >> 6) = 3"; simp)
                  ...
                  subgoal
                    apply (cases "and 3 (reg >> 6) = 1 \<and> and 1 (h >> Suc n) = 0 \<and> and 1 (h >> 3) = 0"; simp)
                    apply (cases "nth_error l_bin (n+3)"; simp)
                    apply (frule list_in_list_nth_error [of _ _ _ "n+3" _], assumption, simp)
                    done
                  ...
                  subgoal
                    apply (simp add: Let_def)
                    apply (cases "and 3 (reg >> 6) = 1 \<and> and 1 (h >> Suc n) = 0"; simp)
                    apply (cases "nth_error l_bin (n+3)"; simp)
                    apply (frule list_in_list_nth_error [of _ _ _ "n+3" _], assumption, simp)
                    subgoal for dis apply (cases "ireg_of_u8 (bitfield_insert_u8 3 (Suc n) (and 7 (reg >> 3)) (and 1 (h >> 2)))"; simp)
                    subgoal for src apply (cases "ireg_of_u8 (bitfield_insert_u8 3 (Suc n) (and 7 reg) (and 1 h))"; simp)
                  ...
                  subgoal
                    ...
                    subgoal for dis apply (cases "ireg_of_u8 (bitfield_insert_u8 3 (Suc n) (and 7 (reg >> 3)) (and 1 (h >> 2)))"; simp)
                    subgoal for src apply (cases "ireg_of_u8 (bitfield_insert_u8 3 (Suc n) (and 7 reg) (and 1 h))"; simp)
                    subgoal for dst apply (cases "and 1 (h >> Suc n) = 0"; simp)
                      by argo
                    done done done done
